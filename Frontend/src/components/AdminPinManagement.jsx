...
import { FaUsers, FaKey, FaSpinner, FaCheckCircle, FaSync, FaTimes } from 'react-icons/fa'
                  ...
                  <tr key={user.id} className="border-b border-white/10">
                    ...
                    <td className="py-3">
                      <button
                        ...
                        className="px-3 py-1 rounded text-sm bg-yellow-500/20 text-yellow-400 hover:bg-yellow-500/30 flex items-center gap-1"
                      >
